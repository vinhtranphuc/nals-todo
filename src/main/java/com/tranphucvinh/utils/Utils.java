package com.tranphucvinh.utils;
...
public class Utils {
	...
	public static Map<String,Object> responseOK(Object data, String jw) {
		return response(data,jw,"SUCESSFULLY",HttpStatus.OK);
	}
	...
	public static Map<String,Object> responseERROR(String message) {
		return response(null,null,message,HttpStatus.INTERNAL_SERVER_ERROR);
	}

	public static Map<String,Object> responseERROR(HttpStatus status,String message) {
