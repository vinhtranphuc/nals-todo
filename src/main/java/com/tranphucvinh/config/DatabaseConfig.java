...
public class DatabaseConfig {
    ...
    public DataSource dataSource() {
    	...
    	dataSource.setUrl("jdbc:mysql://127.0.0.1:3306/nals_todo?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC&zeroDateTimeBehavior=convertToNull");
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		em.setPackagesToScan(new String[] { "com.tranphucvinh.jpa.model" });
